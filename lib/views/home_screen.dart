...
class _HomeScreenState extends ConsumerState<HomeScreen> {
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Text(userResume.currentPosition!=null && userResume.currentPosition!.isNotEmpty ? userResume.currentPosition.toString() : "Untitled $index",style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontSize: 18.sp,fontWeight: FontWeight.w600),),
                        ],
                      ),
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 4.w,),
                          Text(userResume.fullName.isNotEmpty?userResume.fullName: "",style: Theme.of(context).textTheme.headlineSmall,),
                        ],
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          ...
                          SizedBox(width: 4.w,),
                          Text(userResume.email!=null && userResume.email!.isNotEmpty? userResume.email.toString(): "",style: Theme.of(context).textTheme.headlineSmall,),
                        ],
                      ),
                    ],
                  ),
              ...
              Row(
                ...
                children: [
                  ...
                  iconTextButton(Icon(Icons.remove_red_eye_rounded,color: Colors.white,size: 20.sp,),"View Cv",(){
                    TemplateData templateData= convertToTemplateData(userResume);
                    print(templateData.fullName);
                    Navigator.of(context).push(MaterialPageRoute(builder: (context)=> ViewCv(templateData: templateData,)));
  ...
  TemplateData convertToTemplateData(TemplateDataModel userResume) {
    ...
    return TemplateData(
        ...
        phoneNumber: userResume.phoneNumber==null? null:userResume.phoneNumber!.isNotEmpty?userResume.phoneNumber:null,
        currentPosition: userResume.currentPosition==null? null:userResume.currentPosition!.isNotEmpty?userResume.currentPosition:null,
        country:userResume.country==null? null:userResume.country!.isNotEmpty?userResume.country:null,
