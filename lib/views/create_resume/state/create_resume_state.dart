...
final templateDataModel =
    StateProvider<TemplateDataModel>((ref) => TemplateDataModel());
...
Future<void> setTemplateData(WidgetRef ref, TemplateDataModel data) async {
  TemplateDataModel templateData = ref
      .read(templateDataModel.notifier)
      .state
      .copyWith(
...
Future<void> setTemplateEducationData(
    WidgetRef ref, List<Education> data) async {
  TemplateDataModel templateData = ref
      .read(templateDataModel.notifier)
      .state
      .copyWith(educationDetails: data);
  ref.read(templateDataModel.notifier).state = templateData;
  await LocalDB.updateTemplateData(templateData, ref);
}

Future<void> setTemplateExperienceData(
    WidgetRef ref, List<ExperienceData> data) async {
  TemplateDataModel templateData =
